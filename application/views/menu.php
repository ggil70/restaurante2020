            ...
            <div class="logo-header" data-background-color="blue2">
                ...
                <a href="<?=base_url('acceso')?>" class="logo">
                    <img src="<?php echo base_url()?>assets/images/logo.jpeg" 
                         alt="navbar brand" class="navbar-brand" style="width:140px; height:65px">
                </a>
                    ...
                    <div class="user">
                        ...
                        <div class="info">
                            <a data-toggle="collapse" href="#collapseExample" aria-expanded="true">
                                <span>
                                    Pedro Perez
                                    <span class="user-level">Administrador sistema</span>
                    ...
                    <ul class="nav nav-primary">
                      ...
                      <?php
                          ...
                          while($i <= $nroFilaModulo){
							  ...
							  $titulo = strtolower($arregloPermisoModulo[$i][1]);
